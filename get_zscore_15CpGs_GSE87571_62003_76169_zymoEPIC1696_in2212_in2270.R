...
#cntrl_mean <- as.matrix(apply(cntrl,2,mean))
#cntrl_sd <- as.matrix(apply(cntrl,2,sd))
#cntrl_m_sd <- cbind(cntrl_mean,cntrl_sd)
#write.csv(cntrl_m_sd,"GSE87571_meth_mean_sd.csv",quote=F)
